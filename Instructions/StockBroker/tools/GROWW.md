...
- This toolkit **is** Groww. Agents should call it only when it is assigned on the team/agent — not because Stock Broker “defaults” to Groww.
- On 401 / auth failure → treat as auto-disarm; ask the user to refresh this broker’s Access Token (daily ~06:00 IST).
