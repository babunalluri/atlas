...
/** Consistent leading icon size for text buttons. */
export const BUTTON_ICON_CLASS = "h-3.5 w-3.5 shrink-0";

function buttonIconClass(className?: string, defaultClass = BUTTON_ICON_CLASS) {
...
export function CloneIcon({ className }: { className?: string }) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function SettingsGearIcon({ className }: { className?: string }) {
  return (
    <svg
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      className={buttonIconClass(className, "h-4 w-4 shrink-0")}
      aria-hidden
    >
...
export function EyeOffIcon({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      <path d="M6.1 6.1C3.6 7.8 2 12 2 12s3.5 7 10 7a10.4 10.4 0 0 0 4.4-1" />
    </svg>
  );
}
...
/** User-facing workspace / desk (sidebar + content). */
...
/** Alias for traces / activity history actions. */
export const TracesIcon = HistoryIcon;
